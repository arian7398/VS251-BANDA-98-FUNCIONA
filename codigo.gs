...
const USUARIOS = [
  ...
  { username: 'fecore1', password: '123', role: 'admin', email: 'fecore1@ejemplo.com' },
  { username: 'fecore2', password: '123', role: 'admin', email: 'fecore2@ejemplo.com' },
  { username: 'fecore3', password: '123', role: 'admin', email: 'fecore3@ejemplo.com' },
  { username: 'fecore4', password: '123', role: 'admin', email: 'fecore4@ejemplo.com' },
  { username: 'neyra', password: 'neyra', role: 'admin', email: 'informaticafecor@gmail.com' }
